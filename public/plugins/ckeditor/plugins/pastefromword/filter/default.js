...
(function () {
    ...
    function E(a) {
        ...
        for (var c = 1, b = 1; 0 < a.length; b *= 26)
            (c +=
                "ABCDEFGHIJKLMNOPQRSTUVWXYZ".indexOf(a.charAt(a.length - 1)) *
                b),
                        ...
                        if (((b = c[q]), "cke:li" == b.name))
                            if (
                                ...
                                if (l) {
                                    ...
                                    a.push(
                                        (l = new CKEDITOR.htmlParser.element(
                                            p,
                                        )),
                                    ),
                                        l.add(b),
