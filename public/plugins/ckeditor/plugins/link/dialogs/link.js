    ...
    CKEDITOR.dialog.add("link", function (e) {
        var m = CKEDITOR.plugins.link,
            ...
            q = function () {
                ...
                if (b && a)
                    switch (
                        ((b = b.getElement()), b.hide(), a.setValue(""), n)
                    ) {
                        case "frame":
                    ...
                    elements: [
                        {
                            ...
                            setup: function () {
                                this.enable();
                                this.setValue(
                                    e.getSelection().getSelectedText(),
                                );
                                p = this.getValue();
                            },
                            commit: function (a) {
            ...
            onShow: function () {
                var a = this.getParentEditor(),
                    ...
                    d = this.getContentElement("info", "linkDisplayText")
                        ...
                        .getParent(),
                    e = null;
                (e = m.getSelectedLink(a)) && e.hasAttribute("href")
                    ? c || (b.selectElement(e), (c = e))
                    : (e = null);
            ...
            onOk: function () {
                ...
                if (this._.selectedElement) {
                    ...
                    b.collapsed
                        ...
                        : p !== a.linkText &&
                          ((a = new CKEDITOR.dom.text(a.linkText, e.document)),
                          b.shrink(CKEDITOR.SHRINK_TEXT),
                          e.editable().extractHtmlFromRange(b),
                          b.insertNode(a));
                    a = b._find("a");
