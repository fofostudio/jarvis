...
(function () {
    ...
    var J = function (b) {
            var c, e, d;
            for (d in b)
                (c = (c = a.dialog.getContentElement(
        ...
        O = {
            ...
            grammerSuggest: function (b) {
                ...
                for (var c = b.length, e = !0, d = 0; d < c; d++)
                    a.grammerSuggest.getElement().append(L(b[d], b[d], e)),
                        (e = !1);
                v();
                a.div_overlay.setDisable();
            },
    ...
    CKEDITOR.dialog.add("options", function (b) {
        ...
        return {
            ...
            onShow: function () {
                ...
                d.IgnoreMixedCaseWords = e.IgnoreMixedCaseWords.getValue()
                    ? 1
                    : 0;
