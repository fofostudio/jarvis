        ...
        upload: {
            ...
            onSuccess: function (result, item) {
                ...
                if (data.isSuccess && data.files.length) {
                    ...
                    if (data.files[0].format == "image") {
                        var first_amount = parseInt($(".pay_amount").text());

                        var final_amount = first_amount + image_message_charge;
                    } else if (data.files[0].format == "video") {
                        var first_amount = parseInt($(".pay_amount").text());

                        var final_amount = first_amount + video_message_charge;
                    }

                    //  else

                    //  if(data.files[0].format=='audio')

                    // {

                    //     var first_amount = parseInt($('.pay_amount').text());

                    //     var final_amount=first_amount+music_message_charge;

                    // }

                    $(".pay_amount").text(final_amount);
