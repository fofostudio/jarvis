    ...
    ($.fn.fileuploader = function (q) {
                ...
                f = {
                    ...
                    set: function (e, t) {
                        switch (e) {
                            ...
                            case "feedback":
                                ...
                                break;
                            case "input":
                                var d = f._assets.copyAllAttributes(
                                    $('<input type="file">'),
                                    s,
                                    !0,
                                );
                    ...
                    onChange: function (e, t) {
                        ...
                        if (
                            ...
                            !f.isDefaultMode() || (f.reset(), 0 != i.length))
                        ) {
                            if (
                                n.beforeSelect &&
                                $.isFunction(n.beforeSelect) &&
                                0 == n.beforeSelect(i, l, p, o, s)
                            )
                                return !1;
                    ...
                    thumbnails: {
                        create: function () {
                            ...
                            var e = $(
                                f._assets.textParse(n.thumbnails.box),
                            ).appendTo(
                        ...
                        item: function (t, e) {
                            (t.icon = f.thumbnails.generateFileIcon(
                                t.format,
                                t.extension,
                            )),
                                (t.image =
                                    '<div class="fileuploader-item-image"></div>'),
                                (t.progressBar = f.isUploadMode()
                                    ? '<div class="fileuploader-progressbar"><div class="bar"></div></div>'
                                    : ""),
                                (t.html = $(
                                    f._assets.textParse(
                                        t.appended && n.thumbnails.item2
                                            ? n.thumbnails.item2
                                            : n.thumbnails.item,
                                        t,
                                    ),
                                )),
                                (t.progressBar = t.html.find(
                        ...
                        renderThumbnail: function (d, e, t) {
                            function u(e) {
                                ...
                                h
                                    ...
                                    .html(t),
                                    d.html.hasClass("file-will-popup") &&
                                        d.html
                            ...
                            function c() {
                                ...
                                if (d && -1 < f._pfrL.indexOf(d))
                                    for (
                                        f._pfrL.splice(f._pfrL.indexOf(d), 1);
                                        e < f._pfrL.length;
                            ...
                            var h = d.html.find(".fileuploader-item-image"),
                                ...
                                m = function () {
                                    h.addClass("fileuploader-no-thumbnail"),
                                        h
                                            .removeClass("fileuploader-loading")
                                            .html(d.icon),
                                        d.html.hasClass("file-will-popup") &&
                                            d.html
                                                .removeClass("file-will-popup")
                            ...
                            if (h.length) {
                                if (
                                    ...
                                    if (
                                        (d.html.hasClass("file-has-popup") &&
                                            d.html
                                              ...
                                              function () {
                                                  r(
                                                      d.reader.frame ||
                                                          (d.reader.node &&
                                                          "img" ==
                                                              d.reader.node.nodeName.toLowerCase()
                                                              ? d.reader.src
                                                              : null),
                                                      !0,
                                                  );
                        ...
                        popup: function (d, r) {
                            ...
                            !f.locked &&
                                ...
                                0 == u.length &&
                                    (u = $(
                                        '<div class="fileuploader-popup"></div>',
                                    ).appendTo(a)),
                                u
                                    .fadeIn(400)
                                    .addClass("loading")
                                ...
                                !d.popup.html
                                    ? f.files.read(d, function () {
                                          d.reader.node &&
                                              ...
                                              d.reader.node
                                                  ? ((d.popup.node =
                                                        d.reader.node.cloneNode()),
                                                    d.popup.node.complete
                                                        ? e()
                                                        : ((d.popup.node.src =
                                                              ""),
                                                          (d.popup.node.onload =
                                                              d.popup.node.onerror =
                                                                  e),
                                                          (d.popup.node.src =
                                                              d.reader.node.src)))
                                                  : e();
                    ...
                    editor: {
                        ...
                        crop: function (w, e) {
                            ...
                            if (
                                !(
                                    w.popup &&
                                    w.popup.html &&
                                    $("html").find(w.popup.html).length
                                )
                            )
                                return (w.editor.crop = e || w.editor.crop);
                            w.popup.node &&
                                (w.popup.editor.cropper
                                    ? (e && (w.popup.editor.cropper.crop = e),
                                      w.popup.editor.cropper.init(e))
                                    : ((t = w.popup.html.find(
                                      ...
                                      (w.popup.editor.cropper = {
                                          ...
                                          init: function (o) {
                                              var i = w.popup.editor.cropper,
                                                  ...
                                                  t =
                                                      i.$imageEl[0].getBoundingClientRect()
                                                          .width,
                                                  r =
                                                      i.$imageEl[0].getBoundingClientRect()
                                                          .height,
                                                  a =
                                                      w.popup.editor.rotation &&
                                                      -1 <
                                                          [90, 270].indexOf(
                                                              w.popup.editor
                                                                  .rotation,
                                                          )
                                                          ? w.popup.editor.scale
                                                          : 1;
                                              if (
                                                  (i.hide(),
                                                  i.crop || i.setDefaultData(),
                                                  0 == t || 0 == r)
                                              )
                                                  return i.hide(!0);
                                              i.isCropping ||
                        ...
                        resize: function (e, t, o, i, n, r) {
                            ...
                            r && s < o && ((p *= o / s), (s = o)),
                                r && p < i && ((s *= i / p), (p = i));
                            var d = Math.min(
                                Math.ceil(Math.log(e.width / s) / Math.log(2)),
                                12,
                            );
                            if (
                                ((t.width = s),
                                ...
                                (s.popup.zoomer ||
                                    ...
                                    (s.popup.zoomer = {
                                        ...
                                        updateView: function (e, t) {
                                            var o = this,
                                                i =
                                                    (o.getImageSize().width /
                                                        100) *
                                                    e,
                                                n =
                                                    (o.getImageSize().height /
                                                        100) *
                                                    e,
                                                r = d.width(),
                                                a = d.height(),
                    ...
                    sorter: {
                            ...
                            function t() {
                                (f.sorter.sort = {
                                    ...
                                    placeholder: n.sorter.placeholder
                                        ...
                                        : $(a.html.get(0).cloneNode()).addClass(
                                ...
                                3 == e.which ||
                                    ...
                                    !(
                                        ...
                                        (!i.is(n.sorter.selectorExclude) &&
                                            !i.closest(n.sorter.selectorExclude)
                                                .length)
                                    ) ||
                                    (e.preventDefault(),
                                    "mousedown" == o && t(),
                        ...
                        mousemove: function (e) {
                            ...
                            if (b) {
                                var w =
                                        o.placeholder.offset().left !=
                                        b.offset().left,
                                    x =
                                        o.placeholder.offset().top !=
                                        b.offset().top;
                                if (
                                    f.sorter.sort.lastHover &&
                                    f.sorter.sort.lastHover.el == b[0]
                                ) {
                                    if (
                                        x &&
                                        "before" ==
                                            f.sorter.sort.lastHover.direction &&
                        ...
                        save: function (e) {
                            ...
                            $.each(t, function (e, t) {
                                ...
                                if (o) {
                                    ...
                                    f.rendered &&
                                        o.index != r &&
                                        (f._itSl && f._itSl.indexOf(o.id), 1) &&
                                        (i = !0),
                                        (o.index = r),
                                        a.push(o),
                                        d.push(o.id),
                                ...
                                f._itSl &&
                                    f._itSl.length != d.length &&
                                    (i = !0),
                                (f._itSl = d),
                                i &&
                                    a.length == f._itFl.length &&
                                    (f._itFl = a),
                    ...
                    upload: {
                        prepare: function (t, e) {
                            (t.upload = {
                                ...
                                enctype:
                                    n.upload.enctype || "multipart/form-data",
                                cache: !1,
                                contentType: !1,
                                processData: !1,
                            ...
                            if (a.upload) {
                                ...
                                if (
                                    (n.upload.chunk &&
                                        ...
                                        a.upload.chunk &&
                                            ...
                                            0 == a.upload.chunk.i &&
                                                (a.upload.chunk.isFirst = !0),
                                            a.upload.chunk.i ==
                                                a.upload.chunk.total - 1 &&
                                                (a.upload.chunk.isLast = !0),
                                            a.upload.chunk.i <=
                                            a.upload.chunk.total - 1
                                                ? ((r =
                                                      a.upload.chunk.i *
                                                      a.upload.chunk.chunkSize),
                                                  (d = a.file.slice(
                                                      r,
                                                      r +
                                                          a.upload.chunk
                                ...
                                (a.upload.data = a.upload.formData),
                                    ...
                                    (a.upload.complete = function (e, t) {
                                        if (
                                            a.upload.chunk &&
                                            !a.upload.chunk.isLast &&
                                            "success" == t
                                        )
                                            return f.upload.prepare(a, !0);
                                    ...
                                    (a.upload.success = function (e, t, i) {
                                        if (
                                            ...
                                            try {
                                                var r = JSON.parse(e);
                                                a.upload.chunk.temp_name =
                                                    r.fileuploader.temp_name;
                                            } catch (e) {}
                                    }),
                                    (a.upload.error = function (e, t, i) {
                                        a.upload.chunk &&
                                            (a.upload.chunk.i = Math.max(
                                                -1,
                                                a.upload.chunk.i - 1,
                                            )),
                                            (a.uploaded = !1),
                        ...
                        retry: function (e) {
                            e &&
                                ...
                                (e.html &&
                                    n.thumbnails._selectors.retry &&
                                    e.html
                                        .find(n.thumbnails._selectors.retry)
                                        .remove(),
                    ...
                    dragDrop: {
                        onDragEnter: function (e) {
                            clearTimeout(f.dragDrop._timer),
                                n.dragDrop.container.addClass(
                                    "fileuploader-dragging",
                                ),
                                f.set(
                                    "feedback",
                                    f._assets.textParse(n.captions.drop),
                                ),
                    ...
                    files: {
                        add: function (e, t) {
                            var o,
                                ...
                                p = e.type,
                                d = p
                                    ? p.split("/", 1).toString().toLowerCase()
                                    : "",
                                u =
                                    -1 != i.indexOf(".")
                        ...
                        read: function (d, e, t, i, r) {
                            if (
                                ...
                                if (
                                    (((d.reader.src || d.reader._FileReader) &&
                                        !i) ||
                                        (d.reader = {
                                            _FileReader: a,
                                            _callbacks: [],
                                    ...
                                    !t
                                        ? ((g =
                                          ...
                                          (v = h
                                              ? u.createObjectURL(d.file)
                                              : d.file),
                                          (n.thumbnails.pdf.viewer ||
                                              f._assets.hasPlugin("pdf")) &&
                                              ((g.src =
                                                  (n.thumbnails.pdf.viewer ||
                                                      "") + v),
                                              (d.reader.node = g),
                            ...
                            return (
                                ...
                                $.each(f._itFl, function (e, t) {
                                    ...
                                    if (
                                        ((a || r) &&
                                            (o =
                                                (o.choosed && !o.uploaded
                                                    ? "0:/"
                                                    : "") +
                                                (a &&
                                                null !==
                                                    f.files.getItemAttr(t, a)
                        ...
                        check: function (i, r, e) {
                            ...
                            if (
                                null != n.limit &&
                                e &&
                                r.length + f._itFl.length - 1 > n.limit
                            )
                                return (
                                    (a[1] = f._assets.textParse(
                                        n.captions.errors.filesLimit,
                                    )),
                                    (a[3] = !0),
                                    a
                                );
                            ...
                            if (
                                null != n.fileMaxSize &&
                                i.size > f._assets.toBytes(n.fileMaxSize)
                            )
                                return (
                                    (a[1] = f._assets.textParse(
                                        n.captions.errors.fileSize,
                                        i,
                                    )),
                                    a
                                );
                            if (0 == i.size && "" == i.type)
                                return (
                                    (a[1] = f._assets.textParse(
                                        n.captions.errors.remoteFile,
                                        i,
                                    )),
                                    a
                                );
                            if (
                                (4096 == i.size || 64 == i.size) &&
                                "" == i.type
                            )
                                return (
                                    (a[1] = f._assets.textParse(
                        ...
                        remove: function (i, r) {
                            ...
                            (!r &&
                                ...
                                i.popup &&
                                    i.popup.close &&
                                    ((i.popup.node = null), i.popup.close()),
                                i.reader.src &&
                                    ((i.reader.node = null),
                        ...
                        getExifOrientation: function (e, p) {
                            ...
                            (t.onload = function (e) {
                                ...
                                if (t.byteLength && 65496 == t.getUint16(0, !1))
                                    for (
                                        var i = t.byteLength, n = 2;
                                        n < i && !(t.getUint16(n + 2, !1) <= 8);
                                        ...
                                        : (o =
                                          ...
                                          : (o =
                                            ...
                                            : (o =
                                              ...
                                              : (o =
                                                      /#([a-fA-F0-9])([a-fA-F0-9])([a-fA-F0-9])/.exec(
                                                          t,
                                                      ))
                                                ? [
                                                      parseInt(o[1] + o[1], 16),
            ...
            return (
                n.enableApi &&
                    (s.get(0).FileUploader = {
                        ...
                        disable: function (e) {
                            return (
                                f.set("disabled", !0), e && (f.locked = !0), !0
                            );
                        },
                        enable: function () {
        ...
        ($.fn.fileuploader.languages = {
            cz: {
                ...
                feedback2: function (e) {
                    return (
                        e.length +
                        " " +
                        (1 < e.length ? "vybráno souborů" : "vybrán soubor")
                    );
                },
                confirm: "Potvrdit",
                cancel: "Zrušeni",
            ...
            de: {
                button: function (e) {
                    return (
                        (1 == e.limit ? "Datei" : "Dateien") + " durchsuchen"
                    );
                },
                feedback: function (e) {
                    return (
                        (1 == e.limit ? "Datei" : "Dateien") +
                ...
                errors: {
                    filesLimit: function (e) {
                        return (
                            "Nur ${limit} " +
                            (1 == e.limit ? "Datei darf" : "Dateien dürfen") +
                            " hochgeladen werden."
                        );
                    },
                    filesType:
                        "Nur ${extensions} Dateien dürfen hochgeladen werden.",
                    fileSize:
            ...
            dk: {
                ...
                removeConfirmation:
                    "Er du sikker på, du ønsker at slette denne fil?",
                errors: {
                    filesLimit: function (e) {
                        return (
                    ...
                    filesType:
                        "Det er kun tilladt at uploade ${extensions} filer.",
                    fileSize:
                    ...
                    fileName:
                        "Du har allerede valgt en fil med navnet ${name}.",
            ...
            en: {
                ...
                feedback2: function (e) {
                    return (
                        e.length +
                        " " +
                        (1 < e.length ? " files were" : " file was") +
                        " chosen"
                    );
                },
                confirm: "Confirm",
                ...
                errors: {
                    ...
                    filesType:
                        "Only ${extensions} files are allowed to be uploaded.",
                    fileSize:
                    ...
                    fileName:
                        "A file with the same name ${name} is already selected.",
            ...
            es: {
                button: function (e) {
                    return (
                        "Examinar " + (1 == e.limit ? "archivo" : "archivos")
                    );
                },
                feedback: function (e) {
                    return (
                        "Selecciona " + (e.limit, "archivos") + " para subir"
                    );
                },
                feedback2: function (e) {
                    return (
                ...
                errors: {
                    filesLimit: function (e) {
                        return (
                            ...
                            (1 == e.limit ? "archivo" : "archivos") +
                            "."
                        );
                    },
                    filesType:
                        "Solo se pueden seleccionar archivos ${extensions}.",
                    fileSize:
            ...
            fr: {
                button: function (e) {
                    return (
                        "Parcourir " +
                        (1 == e.limit ? "le fichier" : "les fichiers")
                    );
                },
                feedback: function (e) {
                    return (
                ...
                errors: {
                    filesLimit:
                        "Seuls les fichiers ${limit} peuvent être téléchargés.",
                    filesType:
                        "Seuls les fichiers ${extensions} peuvent être téléchargés.",
                    fileSize:
                        "${name} est trop lourd, la limite est de ${fileMaxSize} MB.",
                    filesSizeAll:
                        "Les fichiers que vous avez choisis sont trop lourd, la limite totale est de ${maxSize} MB.",
                    fileName:
                        "Le fichier portant le nom ${name} est déjà sélectionné.",
                    folderUpload:
                        "Vous n'êtes pas autorisé à télécharger des dossiers.",
                },
            },
            it: {
                button: function (e) {
                ...
                errors: {
                    ...
                    filesType:
                        "Solo ${extensions} file possono essere caricati.",
                    fileSize:
                    ...
                    fileName:
                        "Un file con lo stesso nome ${name} è già selezionato.",
            ...
            lv: {
                ...
                feedback2: function (e) {
                    return (
                        e.length +
                        " " +
                        (1 < e.length ? "failus izvelēts" : "fails izvēlēts")
                    );
                },
                confirm: "Saglabāt",
                cancel: "Atcelt",
                ...
                errors: {
                    ...
                    fileName:
                        "Fails ar tādu pašu nosaukumu ${name} jau ir atlasīts.",
            ...
            nl: {
                ...
                feedback: function (e) {
                    return (
                        "Kies " +
                        (1 == e.limit ? "een bestand" : "bestanden") +
                        " om te uploaden"
                    );
                },
                feedback2: function (e) {
                ...
                errors: {
                    ...
                    fileName:
                        "Een bestand met dezelfde naam ${name} is al gekozen.",
            ...
            pl: {
                ...
                errors: {
                    ...
                    fileName:
                        ", Plik o tej samej nazwie ${name} już został wybrany.",
            ...
            pt: {
                button: function (e) {
                    return (
                        "Escolher " + (1 == e.limit ? "arquivo" : "arquivos")
                    );
                },
                feedback: function (e) {
                    return (
                        "Escolha " +
                        (1 == e.limit ? "arquivo" : "arquivos") +
                        " a carregar"
                    );
                },
                feedback2: function (e) {
                ...
                errors: {
                    ...
                    filesType:
                        "Somente arquivos ${extensions} podem ser carregados.",
                    fileSize:
                    ...
                    fileName:
                        "Um arquivo com o mesmo nome ${name} já está selecionado.",
            ...
            ro: {
                ...
                errors: {
                    ...
                    fileName:
                        "Fișierul cu același numele ${nume} a fost deja selectat.",
            ...
            ru: {
                ...
                feedback2: function (e) {
                    return (
                        e.length +
                        " " +
                        (1 < e.length ? "файлов выбрано" : "файл выбран")
                    );
                },
                confirm: "Сохранить",
                cancel: "Отмена",
                ...
                errors: {
                    ...
                    filesType:
                        "Только ${extensions} файлы могут быть загружены.",
                    fileSize:
            ...
            tr: {
                ...
                errors: {
                    filesLimit: function (e) {
                        return (
                            "Sadece ${limit} " +
                            (1 == e.limit ? "dosya" : "dosyalar") +
                            " yüklenmesine izin verilir."
                        );
                    },
                    filesType:
                        "Sadece ${extensions} dosyaların yüklenmesine izin verilir.",
                    fileSize:
                    ...
                    fileName:
                        "Aynı ada sahip bir dosya ${name} zaten seçilmiştir.",
                    ...
                    template: function (e) {
                        return (
                            ...
                            ("image" == e.format && e.reader.node && e.editor
                                ? (e.editor.cropper
                                      ? '<li><button type="button" data-action="crop"><i class="fileuploader-icon-crop"></i> ${captions.crop}</button></li>'
                                      : "") +
                                  (e.editor.rotate
                                      ? '<li><button type="button" data-action="rotate-cw"><i class="fileuploader-icon-rotate"></i> ${captions.rotate}</button></li>'
                                      : "")
                                : "") +
                            ("image" == e.format
                            ...
                            (e.data.url
                                ? '<li><a href="' +
                                  e.data.url +
                                  '" data-action="open" target="_blank"><i class="fileuploader-icon-external"></i> ${captions.open}</a></li>'
                                : "") +
                    ...
                    onShow: function (t) {
                        t.popup.html
                            ...
                            .on("click", '[data-action="save"]', function (e) {
                                t.editor && t.editor.save(),
                                    t.popup.close && t.popup.close();
                            });
                    },
                    onHide: null,
                },
