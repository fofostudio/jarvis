...
(function ($) {
                ...
                .ajaxForm({
                    ...
                    uploadProgress: function (
                        ...
                        if (percentComplete == 100) {
                            bar.removeClass("bg-primary").addClass(
                                "bg-success",
                            );
    ...
    $(document).on("click", ".delete-comment", function (e) {
        ...
        swal(
            ...
            function (isConfirm) {
                if (isConfirm) {
                    $.post(
                        URL_BASE + "/ajax/delete-comment/" + id,
                        function (data) {
                            if (data.success) {
                                element
                                    .parents(".wrapComments")
    ...
    $(document).on("click", "#updatesPaginator .loadPaginator", function (e) {
        ...
        if (is_profile == true) {
            ...
            var url_pagination =
                URL_BASE + "/ajax/user/likes?skip=" + allElements;
            ...
            var url_pagination =
                URL_BASE + "/ajax/user/updates?skip=" + allElements;
        }
    ...
    $("#contentLocked").on("click", function () {
        if ($(this).hasClass("unlock")) {
            ...
            $(this)
                .html(
                    '<i class="feather icon-lock" style="font-size:25px;"></i>',
                )
                .removeClass("unlock");
        } else {
            $("#customCheckLocked").trigger("click");
            ...
            $(this)
                .html(
                    '<i class="feather icon-unlock" style="font-size:25px;"></i>',
                )
                .addClass("unlock");
        }
    });
            ...
            if ($(this).val()) {
                ...
                if (ftype == "video/mp4" || ftype == "video/quicktime") {
                    ...
                    if (oFile.name.length > 30) {
                        var $fileName =
                            oFile.name.substring(0, 30) + "(...)" + $extension;
                    } else {
                        var $fileName = oFile.name;
                    }

                    $("#previewImage").html(
                        '<i class="fa fa-play-circle text-info mr-1"></i> ' +
                            $fileName,
                    );
                ...
                if (ftype == "audio/mpeg") {
                    if (oFile.name.length > 30) {
                        var $fileName =
                            oFile.name.substring(0, 30) + "(...)" + ".mp3";
                    } else {
                        var $fileName = oFile.name;
                    }

                    $("#previewImage").html(
                        '<i class="fa fa-music text-info mr-1"></i> ' +
                            $fileName,
                    );
                ...
                oFReader.onload = function (e) {
                    ...
                    image.onload = function () {
                        ...
                        var fileName = _filname.substr(
                            0,
                            _filname.lastIndexOf("."),
                        );
                    }; // <<--- image.onload
                };
    ...
    $(document).ready(function () {
        $("#showHidePassword .c-pointer").on("click", function () {
            if ($("#showHidePassword input").attr("type") == "text") {
                ...
                $("#showHidePassword .c-pointer > i").removeClass(
                    "icon-eye-off",
                );
    ...
    $("#fileZip").on("change", function () {
        ...
        if (
            ...
            if ($(this).val()) {
                var oFReader = new FileReader(),
                    rFilter =
                        /^(?:application\/x-zip-compressed|application\/zip)$/i;
                ...
                $("#previewImage").html(
                    '<i class="fa fa-paperclip text-info"></i> <strong>' +
                        oFile.name +
                        "</strong>",
                );
    ...
    $(document).on("click", ".refresh_creators", function (e) {
        ...
        var free = btnFreeCreators.hasClass("findFreeCreators")
            ? "?type=free"
            : "";
    ...
    $(document).on("click", ".likeComment", function () {
        ...
        $.post(
            ...
            { comment_id: commentId, typeComment: type },
            function (data) {
    ...
    $(document).on(
        "click",
        ".plyr__control, .plyr__video-wrapper",
        function (e) {
