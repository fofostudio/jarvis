                    ...
                    .ajaxForm({
                        ...
                        success: function (result) {
                            ...
                            if (
                                (result.success == true &&
                                    payment == "wallet") ||
                                (result.success && result.instantPayment)
                            ) {
                                swal({
                                    title: thanks,
    ...
    $("#tipForm").on("show.bs.modal", function (event) {
        ...
        $(tipAmount).on("keyup", function () {
            ...
            if (
                ...
                for (var i = 1; i <= taxes; i++) {
                    var percentage = modal
                        .find(".percentageAppliedTax" + i)
                        .attr("data");
                ...
                modal
                    .find(".subtotalTip")
                    .html(parseFloat(valueOriginal).toFixed(decimalZero));

                var totalTip = parseFloat(
                    parseFloat(valueOriginal) + parseFloat(totalTaxes),
                ).toFixed(decimalZero);
