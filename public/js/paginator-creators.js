...
(function ($) {
    ...
    $(document).on("click", ".paginatorMsg", function (r) {
        ...
        $(
            '<div class="w-100 p-3 d-block text-center loadMoreMsgSpinner"><span class="spinner-border text-primary"></span></div>',
        ).appendTo("#containerWrapCreators");

        var page = $(this).attr("data-url").split("page=")[1];

        var params =
            query != "" || requestGender ? "&page=" + page : "?page=" + page;
