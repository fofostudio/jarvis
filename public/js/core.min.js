    ...
    (G = Error),
        ...
        (M = function (t) {
            ...
            if (!q.length && P.ajax) {
                ...
                if (
                    ((t = t.toUpperCase()), 0 <= Q.call(P.ajax.trackMethods, t))
                )
                    return !0;
            }
            return !1;
        ...
        (k = function () {
            ...
            if (!E(e))
                return y.running ||
                    (!1 === P.restartOnRequestAfter && "force" !== M(i))
                    ? void 0
                    : ((o = arguments),
            ...
            (this.progress = 0),
                ...
                (n = setInterval(function () {
                    ...
                    return (
                        ...
                        (e = p(o)),
                        ++s >= P.eventLag.minSamples &&
                        e < P.eventLag.lagThreshold
...
!(function (f) {
    ...
    (o.prototype = {
        init: function () {
            ...
            var t = f.isFunction(e.o.atStart)
                ? e.o.atStart.call(e.e)
                : e.o.atStart;
            "hide" ==
            (t = void 0 !== e.e.attr("data-start") ? e.e.attr("data-start") : t)
                ? e.hide(0)
                : e.show(0);
        },
        show: function (e) {
            ...
            if ((o.find("[data-ctrl]").remove(), "block" == t.mode))
                t.blockMode(o, "show", e, a);
            else {
        ...
        hide: function (e) {
            ...
            if (
                (o.find("[data-ctrl]").remove(),
                "chars" == t.mode || "words" == t.mode)
            ) {
                var n = o.html(),
            ...
            if ("lines" == t.mode) {
                ...
                if (0 == (c = s.find("[data-col-char]")).length) {
                    var c = f(
                        '<span style="display:none" data-col-char>.</span>',
                    );
                    s.prepend(c);
                }
                var d = c.height(),
            ...
            "block" == t.mode && t.blockMode(o, "hide", e, a),
                ...
                "block" != t.mode &&
                    ...
                    !f.isFunction(t.o.controlBtn) &&
                        0 < t.remaining &&
                        o.append(t.ctrlButton),
