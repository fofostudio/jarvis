                    ...
                    var p = function (t) {
                            ...
                            template: {
                                ...
                                viewerItemBody: function (t, e, n) {
                                    return '<div \n                    class="item itemStory '
                                        ...
                                        .concat(
                                            i(n, "story"),
                                            '"><div class="modal-text-story" style="font-family:',
                                        )
                        ...
                        h = (function () {
                            ...
                            var g = a("#zuck-modal-content"),
                                ...
                                I = function (t, e, n) {
                                    ...
                                    L.innerHTML = u("template", "viewerItem")(
                                        t,
                                        b,
                                    );
                            ...
                            return {
                                show: function (t, e) {
                                    ...
                                    u("callbacks", "onOpen")(t, function () {
                                        g.innerHTML =
                                            '<div id="zuck-modal-slider-'.concat(
                                                y,
                                                '" class="slider"></div>',
                                            );
                                    ...
                                    u("callbacks", "onEnd")(
                                        ...
                                        function () {
                                            ...
                                            e &&
                                                ...
                                                (d.data[t].seen = !0),
                                                (d.internalData.seenItems[t] =
                                                    !0),
                                                E(
                                                    "seenItems",
                                                    d.internalData.seenItems,
                                                ),
                                                w()),
                                                a(
                                                    "#zuck-modal .story-viewer.next",
                        ...
                        b = function (t, e) {
                            ...
                            try {
                                d.data[n] || (d.data[n] = {}),
                                    (d.data[n].id = n),
                                    (d.data[n].photo =
                                        t.getAttribute("data-photo")),
                                    (d.data[n].name =
                                        t.querySelector(".name").innerText),
                                    (d.data[n].link = t
                                        .querySelector(".item-link")
                                        .getAttribute("href")),
                                    (d.data[n].lastUpdated =
                                        t.getAttribute("data-last-updated")),
                                    (d.data[n].seen = a),
                                    d.data[n].items ||
                                        ((d.data[n].items = []),
                                        (d.data[n].noItems = !0));
                        ...
                        x = function (t, e, n) {
                            ...
                            if (
                                ...
                                if (!r)
                                    return (
                                        (d.internalData.currentVideoElement =
                                            !1),
                                        !1
                                    );
                                    ...
                                    (b = u(
                                        ...
                                        function () {
                                            "previous" === t
                                                ...
                                                (d.data[n].currentItem =
                                                    d.data[n].currentItem + r),
                                                x(c, f, e);
                                        },
                                    );
