                ...
                return {
                    ...
                    onOk: function () {
                        ...
                        if (
                            ...
                            var width = this.getValueOf(
                                "youtubePlugin",
                                "txtWidth",
                            );

                            var height = this.getValueOf(
                                "youtubePlugin",
                                "txtHeight",
                            );
                            ...
                            if (
                                ...
                                url +=
                                    "hl=" +
                                    (this.getParentEditor().config.language
                                        ? this.getParentEditor().config.language
                                        : "en") +
                                    "&amp;version=3";
                        ...
                        var element =
                            CKEDITOR.dom.element.createFromHtml(content);
