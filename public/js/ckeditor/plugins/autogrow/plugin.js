    ...
    function initIframeAutogrow(editor) {
        ...
        function refreshCache() {
            ...
            var body = CKEDITOR.env.quirks
                ? scrollable
                : scrollable.findOne("body");
            if (body) {
                body.setStyle("height", "auto");
                body.setStyle(
                    "min-height",
                    CKEDITOR.env.safari ? "0%" : "auto",
                ); // Safari does not support 'min-height: auto'.
            }
        ...
        function isNotResizable() {
            ...
            return (
                ...
                (maximizeCommand &&
                    maximizeCommand.state == CKEDITOR.TRISTATE_ON)
            );
        }
        ...
        function contentHeight() {
            ...
            var height =
                marker.getDocumentPosition(doc).y + marker.$.offsetHeight;
            marker.remove();
        ...
        function resizeEditor() {
            ...
            if (newHeight != currentHeight && lastHeight != newHeight) {
                ...
                editor.resize(
                    editor.container.getStyle("width"),
                    newHeight,
                    true,
                );
