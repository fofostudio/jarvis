...
(function () {
    ...
    var Jsonp = {
        ...
        sendRequest: function (
            ...
            urlParams.callback =
                "CKEDITOR._.jsonpCallbacks[" + callbackKey + "]";
    ...
    function createWidgetBaseDefinition(editor) {
        ...
        return {
            ...
            init: function () {
                ...
                this.on(
                    ...
                    function (evt) {
                        ...
                        var retHtml = this._responseToHtml(
                            evt.data.url,
                            evt.data.response,
                        );
            ...
            isUrlValid: function (url) {
                return (
                    this.urlRegExp.test(url) &&
                    this.fire("validateUrl", url) !== false
                );
            },
