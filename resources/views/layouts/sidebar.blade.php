@if (auth()->user()->role == 'super_admin' || auth()->user()->role == 'admin')
    ...
    <li class="nav-item">
        <a href="{{ route('platforms.index') }}"
            class="nav-link text-truncate @if (request()->routeIs('FoodItems.*')) active @endif">
            <i class="bi-display me-2"></i> {{ __('admin.FoodItems') }}
        </a>
    </li>
    <li class="nav-item">
...
@elseif (auth()->user()->role == 'operator')
    ...
    <li class="nav-item">
        <a href="{{ route('my_work_plan') }}"
            ...
            <i class="bi-calendar-check me-2"></i> {{ __('operator.my_foodItems') }}
        </a>
    </li>
    <li class="nav-item">
        <a href="{{ route('my_work_plan') }}"
...
@if (auth()->user()->role == 'coperative')
    <li class="nav-item">
        <a href="{{ route('profile.edit') }}"
            class="nav-link text-truncate @if (request()->routeIs('profile.edit')) active @endif">
            <i class="bi-gear me-2"></i> {{ __('operator.foodAdmin') }}
        </a>
    </li>
    <li class="nav-item">
        <a href="{{ route('profile.edit') }}"
            class="nav-link text-truncate @if (request()->routeIs('profile.edit')) active @endif">
            <i class="bi-gear me-2"></i> {{ __('operator.foodProducts') }}
        </a>
    </li>
    <li class="nav-item">
        <a href="{{ route('profile.edit') }}"
            class="nav-link text-truncate @if (request()->routeIs('profile.edit')) active @endif">
            <i class="bi-gear me-2"></i> {{ __('operator.foodReports') }}
        </a>
    </li>
    <li class="nav-item">
        <a href="{{ route('profile.edit') }}"
