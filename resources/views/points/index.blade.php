    ...
    <div class="content">
        <div class="row">
            <div class="col-lg-12">
                ...
                @php
                    $startDate = new DateTime($dates->min());
                    $endDate = new DateTime($dates->max());
                        ...
                        <div class="card-body p-lg-4">
                            ...
                            <table class="calendar">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                @endif
                <td class="{{ $dates->contains($day->format('Y-m-d')) ? 'bg-success' : 'bg-danger' }}
        ...
        <script>
            function filterRecords(date) {
                window.location.href = "{{ route('points.index') }}?date=" + date;
            }
        </script>
