                        ...
                        <form method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="neighborhood" name="neighborhood" type="text" class="form-control"
                                    value="{{ old('neighborhood', $user->neighborhood) }}" readonly>
                                @error('neighborhood')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <button type="submit"
                                class="btn btn-dark mt-3 px-5 me-2">{{ __('admin.update_profile') }}</button>
                        </form>
                    </div>
                </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('password.update') }}">
                            ...
                            <button type="submit"
                                class="btn btn-dark mt-3 px-5 me-2">{{ __('admin.update_password') }}</button>
                        </form>
                    </div>
                </div>
